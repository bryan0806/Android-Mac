...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		Intent implicitAct = new Intent(Intent.ACTION_VIEW,uri);
		...
		Intent chooserIntent = Intent.createChooser(implicitAct, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == GET_TEXT_REQUEST_CODE){
			if(resultCode == RESULT_OK){
				Log.i(TAG, "Entered inside the getext");
				String getUserText = "";
				getUserText = data.getStringExtra("usertext");
				mUserTextView.setText(getUserText);
			}
		}
