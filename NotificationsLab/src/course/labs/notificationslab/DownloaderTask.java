...
public class DownloaderTask extends AsyncTask<String, Void, String[]> {
	...
	protected void onPostExecute(String[] result) {
		...
		Log.i("myself", "Enter onPostExecute");
		if (mParentActivity != null) {
			Log.i("myself", "mParentActivity != null");
			mParentActivity.setRefreshed(result);
			Log.i("myself", "after setrefreshed result");
		}
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							Log.i("myself", "enter start pendingIntent");
							...
							// successfully
							if(restartMainActivtyIntent != null){
								mContentView.setTextViewText(mContentView.getLayoutId(), successMsg);
							}
